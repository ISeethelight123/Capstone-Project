...
<body>
<a href="/tomanagero">仓库部门</a><br>
<a href="/tomanagerto">财务部门</a><br>
<a href="/tomanagerth">调度部门</a><br>
<a href="/toselect">人事部门</a><br>
<a href="/tojuese">角色管理</a><br>
<a href="/topower">权限管理</a><br>
<a href="/tologin">注销账户</a><br>
</body>
=======
﻿<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
				...
				<div class="demo">
					<ul class="nav">
						...
						<li><a href="#">仓库管理</a>
							<ul>
								<li><b class="tip"></b> <a target="Conframe"
									href="/connect3ion/goWrehouseInfo">仓库信息管理</a></li>
								<li><b class="tip"></b> <a target="Conframe"
						...
						<li><a href="#">调度管理</a> </a>
							<ul>
								<li><b class="tip"></b> <a target="Conframe"
									href="Schedule/manageSchedule/manageSchedule">调度单管理</a></li>
								<li><b class="tip"></b> <a target="Conframe"
...
>>>>>>> branch 'master' of https://github.com/ISeethelight123/Capstone-Project.git
</html>